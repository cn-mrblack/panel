...
const RightNavigation = styled.div`
    ...
    & > .navigation-link {
        ...
        &:active,
        &:hover {
            ${tw`text-gray-100 bg-gray-800/50`};
        }

        &:active,
        &:hover,
        &.active {
            box-shadow: inset 0 -2px ${theme`colors.purple.500`.toString()};
        }
    }
`;
...
export default () => {
    ...
    return (
        <div className={'w-full glass border-b border-gray-700/50 shadow-lg'}>
            ...
            <div className={'mx-auto w-full flex items-center h-[3.5rem] max-w-[1200px]'}>
                <div id={'logo'} className={'flex flex-1'}>
                    <Link
                        ...
                        exact
                        className={
                            'text-2xl font-header px-4 no-underline text-gray-200 hover:text-white transition-colors duration-300'
                        }
                    >
                        {useStoreState((state) => {
